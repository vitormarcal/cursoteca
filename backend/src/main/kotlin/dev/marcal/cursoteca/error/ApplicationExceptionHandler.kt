...
class ApplicationExceptionHandler {
	...
	fun business(error: BusinessException): ResponseEntity<ApiErrorResponse> = response(
		reason = error.reason,
	...
	fun malformed(error: Exception): ResponseEntity<ApiErrorResponse> = response(
	...
	fun unexpected(error: Exception): ResponseEntity<ApiErrorResponse> = response(
	...
	): ResponseEntity<ApiErrorResponse> = ResponseEntity.status(reason.httpStatus).body(
		ApiErrorResponse(
